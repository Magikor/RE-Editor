...
public partial class GenerateFiles {
    ...
    private static readonly List<string> WHITELIST = [
        ...
        "App_user_data_OtomoEquipSeriesData",
        "App_user_data_OtomoEquipSeriesData_cData",
        "App_user_data_OtomoEquipRecipe",
        "App_user_data_OtomoEquipRecipe_cData",
        "App_user_data_OtomoOuterArmorData",
        "App_user_data_OtomoOuterArmorData_cData",
        "App_user_data_CharmData",
        "App_user_data_CharmData_cData",
        "App_user_data_NpcVisualSetting",
